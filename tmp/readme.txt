...
6. Fix an issue that the notes was saved after closing the sidebar.
...
14. Other minor bug fixes and features optimization.
...
Changes of XMind 7.5 Update 1 (v3.6.51)

Improvements

1. Arrange Cloud files under their last modified time.

Bug Fixes

1. Fix a bug that causes sheet name to change after sync.
2. Fix a bug that causes to create a new topic after typing a text and pressing "ENTER" button.
3. Fix an issue that causes interface to be abnormal while adding a new sheet.
4. Fix an issue that causes sync failure after changing the sheet order.
5. Fix an issue that some makers will mistakenly display after being dragged onto the map.
6. Fix an issue that causes all markers to be lost after saving a sheet as a new mind map.
7. Fix an issue that causes all markers of a topic to be lost after saving and pasting that topic.
8. Fix an issue that the zoom value is not saved after closing a map.
9. Fix an issue that causes notes to disappear sometimes.
10. Some other minor bug fixes.



Changes of XMind 7.5 (v3.6.50)
